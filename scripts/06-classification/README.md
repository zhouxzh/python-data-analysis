# scripts/06-classification

Week 6 第一个分类预测模型，使用 pandas 和 scikit-learn。每个文件对应 `06-第一个预测模型.md` 中的一个代码块，按出现顺序排列。

| 文件 | 教程位置 | 用途 |
|---|---|---|
| `01-german-credit-audit.py` | 1.2 | 核对 GermanCredit 标签含义 |
