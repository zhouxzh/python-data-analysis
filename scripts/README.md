...
8 周教程正文直接放在仓库根目录：`第01周-*.md` 到 `第08周-*.md`。本目录中的脚本与每周教程一一对应，主数据统一使用 `data/nyc_airbnb.csv`。
...
| `week04_practice.py` | Week 4 Airbnb 价格 EDA | `python scripts/week04_practice.py` |
| `week05_practice.py` | Week 5 可视化面板 | `python scripts/week05_practice.py` |
