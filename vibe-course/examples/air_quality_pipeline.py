...
用法：
    python vibe-course/examples/air_quality_pipeline.py

输出：
    vibe-course/examples/output/clean_air.csv
    vibe-course/examples/output/air_summary.csv
    vibe-course/examples/output/region_summary.csv
    vibe-course/examples/output/dashboard.png
"""
