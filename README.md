...
| 周 | 主题 | 主案例 | 本周产出 |
|---|---|---|---|
| 1 | [环境安装与第一个数据问题](第01周-从Excel到第一个数据问题.md) | 成绩单 | 环境验证截图 + 1 个可运行的 `.py` 脚本 |
| 2 | [pandas 数据结构与读取](第02周-pandas与数据读取.md) | 城市空气质量 | 数据概览卡片 |
| 3 | [数据清洗与审计](第03周-数据清洗与审计.md) | 脏空气质量表 | 清洗报告 |
| 4 | [EDA 与提出假设](第04周-EDA与提出假设.md) | 银行营销数据 | 3 个发现 + 3 个假设 |
| 5 | [可视化表达](第05周-可视化表达.md) | 空气质量小时数据 | 1 张信息完整的面板 |
| 6 | [合并、分组与迷你项目](第06周-合并分组与迷你项目.md) | 城市人口 + 空气数据 | 迷你分析报告 |
| 7 | [第一个预测模型](第07周-第一个预测模型.md) | Titanic / 银行营销 | 模型评估摘要 |
