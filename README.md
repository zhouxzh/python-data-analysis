...
| 2 | [Python 编程基础](02-pandas与数据读取.md) | 股票、零售、乳腺癌数据 | 三个可运行的 Python 练习脚本 |
| 3 | [pandas 基础](03-数据清洗与审计.md) | 电商、教育、汽车数据 | 三份数据概览卡片 |
| 4 | [数据清洗与审计](04-EDA与提出假设.md) | 电信、汽车、公共健康数据 | 清洗前后对比报告 |
| 5 | [EDA 与可视化](05-可视化表达.md) | 钻石、人口、能源数据 | 3 张信息完整的图 |
| 6 | [合并、分组与迷你项目](06-合并分组与迷你项目.md) | 汽车销量、客流量、营销漏斗 | 迷你分析报告 |
| 7 | [第一个预测模型](07-第一个预测模型.md) | 信贷、房价、客户流失 | 模型评估摘要 |
