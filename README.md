...
| 2 | [pandas 数据结构与读取](02-pandas与数据读取.md) | 纽约 Airbnb 价格 | 数据概览卡片 |
| 3 | [数据清洗与审计](03-数据清洗与审计.md) | 纽约 Airbnb 真实缺失与异常 | 清洗报告 |
| 4 | [EDA 与提出假设](04-EDA与提出假设.md) | 纽约 Airbnb 价格分布 | 3 个发现 + 3 个假设 |
| 5 | [可视化表达](05-可视化表达.md) | 纽约 Airbnb 价格 | 1 张信息完整的面板 |
| 6 | [合并、分组与迷你项目](06-合并分组与迷你项目.md) | Airbnb + 行政区统计 | 迷你分析报告 |
| 7 | [第一个预测模型](07-第一个预测模型.md) | Airbnb 价格回归 | 模型评估摘要 |
| 8 | [结课项目与展示](08-结课项目与展示.md) | 学生自选 | 完整报告 + 3 分钟展示 |
